...
Точка входа в программу начинается с символа `$`, а дальше начинается удивительнейшее путешествие по трубам
...
> Чтобы примерно понять, что происходит, стоит изучить простые программы, мяу
